...
class CateringOrder extends StatefulWidget {
  CateringOrder({Key key}) : super(key: key);

  @override
  _CateringOrderState createState() => _CateringOrderState();
}

class _CateringOrderState extends State<CateringOrder> {
