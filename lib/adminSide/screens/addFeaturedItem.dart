...
class AddFeaturedItem extends StatefulWidget {
  AddFeaturedItem({Key key}) : super(key: key);

  @override
  _AddFeaturedItemState createState() => _AddFeaturedItemState();
}

class _AddFeaturedItemState extends State<AddFeaturedItem> {
