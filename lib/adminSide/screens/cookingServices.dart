...
class CookingServices extends StatefulWidget {
  CookingServices({Key key}) : super(key: key);

  @override
  _CookingServicesState createState() => _CookingServicesState();
}

class _CookingServicesState extends State<CookingServices> {
  Future getCookingServices() async {
      ...
      secondaryActions: [
        Padding(
          ...
          child: GestureDetector(
            onTap: () => Get.to(() => UpdateCookingService(
                  id: id,
                  image: image,
