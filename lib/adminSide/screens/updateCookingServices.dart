...
class UpdateCookingService extends StatefulWidget {
  final String id;
  final String type;
  ...
  @override
  _UpdateCookingServiceState createState() => _UpdateCookingServiceState();
}

class _UpdateCookingServiceState extends State<UpdateCookingService> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text('Update Cooking Service',
