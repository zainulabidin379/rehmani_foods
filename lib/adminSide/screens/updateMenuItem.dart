...
class UpdateMenuItem extends StatefulWidget {
  ...
  final String image;
  final String name;
  UpdateMenuItem({Key key, this.pid, this.id, this.image, this.name}) : super(key: key);
                  ...
                  onTap: () async {
                    if (_formKey.currentState.validate()) {
                      if (image == null) {
                        Get.snackbar(
                          '',
                          "Please select an image to add item.",
                          titleText: Text('Image Not Selected',
                              style: TextStyle(
                                  color: kPrimary,
                        ...
                        await FirebaseFirestore.instance
                          ...
                          Get.snackbar(
                            '',
                            "${_name.text} successfully updated in menu",
